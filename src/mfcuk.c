    ...
    if (res == 4)
    {
        ...
        else
        {
            ...
            if (ptrFoundTagNonceEntry->current_out_of_8 == 8)
            {
                ...
                states_list = lfsr_common_prefix(ptrFoundTagNonceEntry->spoofNrPfx, ptrFoundTagNonceEntry->spoofArEnc, ptrFoundTagNonceEntry->ks, ptrFoundTagNonceEntry->parBitsArr, uiUID, nt);
